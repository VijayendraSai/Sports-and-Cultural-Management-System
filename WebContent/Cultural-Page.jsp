...
<head>
  ...
  <body>
    ...
    <jsp:include page="Navbar.jsp" />
     <br>
     <%
     //This should beused only when integrating for now it is hardcoded
     //String Username=(String)session.getAttribute("Username"); 
     String Username ="CB.EN.U4CSE17625";
     %> 
  ...
  try {
    ...
    ResultSet rs=st.executeQuery("select * from organize where eventtype='cultural' ");
